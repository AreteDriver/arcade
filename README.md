...
Game development monorepo — Bevy/Rust, Unity/C#, Godot/GDScript, Python.
...
| [chronicle-rpg](chronicle-rpg/) | Custom | Python | Active — EVE Online tabletop RPG companion |
...
├── chronicle-rpg/       # EVE Online tabletop RPG companion
